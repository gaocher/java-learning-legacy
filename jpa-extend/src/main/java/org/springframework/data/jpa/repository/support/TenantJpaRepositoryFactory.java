...
import org.springframework.data.jpa.repository.query.TenantJpaQueryLookupStrategy;
import org.springframework.data.querydsl.QueryDslPredicateExecutor;
import org.springframework.data.repository.core.RepositoryInformation;
import org.springframework.data.repository.core.RepositoryMetadata;
import org.springframework.data.repository.core.support.TenantRepositoryFactorySupport;
 ...
 */
@Slf4j
public class TenantJpaRepositoryFactory extends TenantRepositoryFactorySupport {
     ...
     */
    public TenantJpaRepositoryFactory(EntityManager entityManager) {
    ...
    protected QueryLookupStrategy getQueryLookupStrategy(Key key, EvaluationContextProvider evaluationContextProvider) {
        return TenantJpaQueryLookupStrategy.create(entityManager, key, extractor, evaluationContextProvider);
    }
